...
$svg_patterns = array(
    'asanoha' => __('Asanoha', 'propaganda'),
    'batik-pattern' => __('Batik Pattern', 'propaganda'),
    'bats' => __('Bats', 'propaganda'),
    'bells' => __('Bells', 'propaganda'),
    'brick-wall' => __('Brick Wall', 'propaganda'),
    'chinese-pattern' => __('Chinese Pattern', 'propaganda'),
    'circles' => __('Circles', 'propaganda'),
    'clovers' => __('Clovers', 'propaganda'),
    'doodle' => __('Doodle', 'propaganda'),
    'fish-scales' => __('Fish Scales', 'propaganda'),
    'flowers' => __('Flowers', 'propaganda'),
    'grid' => __('Grid', 'propaganda'),
    'herringbone' => __('Herringbone', 'propaganda'),
    'ichimatu' => __('Ichimatu', 'propaganda'),
    'japanese-cubes' => __('Japanese Cubes', 'propaganda'),
    'jigsaw' => __('Jigsaw', 'propaganda'),
    'labyrinth' => __('Labyrinth', 'propaganda'),
    'meandros' => __('Meandros', 'propaganda'),
    'memphis-pattern-1' => __('Memphis Pattern 1', 'propaganda'),
    'memphis-pattern-2' => __('Memphis Pattern 2', 'propaganda'),
    'memphis-pattern-3' => __('Memphis Pattern 3', 'propaganda'),
    'petals' => __('Petals', 'propaganda'),
    'plants' => __('Plants', 'propaganda'),
    'plus' => __('Plus', 'propaganda'),
    'pumpkins' => __('Pumpkins', 'propaganda'),
    'rounded-squares' => __('Rounded Squares', 'propaganda'),
    'san-kuzushi' => __('San Kuzushi', 'propaganda'),
    'seigaiha' => __('Seigaiha', 'propaganda'),
    'seventies-circles' => __('Seventies Circles', 'propaganda'),
    'snowflakes' => __('Snowflakes', 'propaganda'),
    'squiggles' => __('Squiggles', 'propaganda'),
    'waves' => __('Waves', 'propaganda'),
    'windy-clouds' => __('Windy Clouds', 'propaganda'),
);
...
$positions = array(
    ...
    'bottom' => __('Bottom', 'propaganda'),
    'left' => __('Left', 'propaganda'),
    'top' => __('Top', 'propaganda'),
);
