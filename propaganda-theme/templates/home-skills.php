<?php if (get_theme_mod('pt_skills_displayed', true)) : ?>
    <!-- Skills -->
    <section id="hp-skills" class="<?php if (!get_theme_mod('pt_skills_expanded', false)) : ?>toggleActivated<?php endif; ?>">
        <div class="container">
            <div class="heading-wrapper heading-<?php echo get_theme_mod('pt_skills_general_color', false) ? 'primary' : 'secondary'; ?> align-<?php echo get_theme_mod('pt_skills_heading_alignment', 'left'); ?>">
                <h2><?php echo get_theme_mod('pt_skills_heading_title', "Навыки и умения"); ?></h2>
                <h3><?php echo get_theme_mod('pt_skills_heading_subtitle', "В чем ты хорош?"); ?></h3>
            </div>
            <div class="card-grid card-grid-framed card-grid-<?php echo get_theme_mod('pt_skills_general_color', false) ? 'primary' : 'secondary'; ?> skills-grid">
                ...
                for ($count = 1; $count <= $items; $count++) { ?>
                    <div class="grid-item skill <?php if ($count > 4) : ?>toBeRevealed<?php endif; ?>" <?php if (get_theme_mod('pt_skills_content_' . $count . '_pill', ($count == 2) ? 'Новый' : '')) : ?>data-pill="<?php echo get_theme_mod('pt_skills_content_' . $count . '_pill', ($count == 2) ? 'Новый' : ''); ?>" <?php endif; ?>>
                        <div class="icon">
                            <img src="<?php echo get_template_directory_uri(); ?>/assets/icons/<?php echo get_theme_mod('pt_skills_content_' . $count . '_icon', 'military-medal'); ?>.svg" alt="<?php echo str_replace("-", " ", get_theme_mod('pt_skills_content_' . $count . '_icon', 'military-medal')); ?> icon" class="undraggable">
                        </div>
                        <h4><?php echo get_theme_mod('pt_skills_content_' . $count . '_title', 'молодец товарищ'); ?></h4>
                    </div>
                <?php } ?>
            </div>
            ...
            <?php if (get_theme_mod('pt_skills_subsection_displayed', true)) : ?>
                <div id="extra-skills" class="toBeRevealed">
                    <div class="heading-wrapper align-<?php echo get_theme_mod('pt_skills_heading_alignment', 'left'); ?>">
                        <h3><?php echo get_theme_mod('pt_skills_subsection_subtitle', "Ключевое значение имеет точность"); ?></h3>
                    </div>
                    <div class="col-2">
                        <div class="col">
                            <?php $items = get_theme_mod('pt_skills_subsection_col_1_grid_items', "4");
                            for ($count = 1; $count <= $items; $count++) { ?>
                                <h4 class="color-<?php echo get_theme_mod('pt_skills_general_color', false) ? 'primary' : 'secondary'; ?>"><?php echo get_theme_mod('pt_skills_subsection_col_1_items' . $count . '_list_title', 'Язык программирования'); ?></h4>
                        ...
                        <div class="col">
                            ...
                            for ($count = 1; $count <= $items; $count++) { ?>
                                <h4 class="color-<?php echo get_theme_mod('pt_skills_general_color', false) ? 'primary' : 'secondary'; ?>"><?php echo get_theme_mod('pt_skills_subsection_col_2_items' . $count . '_list_title', 'Язык программирования'); ?></h4>
                                <ul class="list list-<?php echo !get_theme_mod('pt_skills_general_color', false) ? 'primary' : 'secondary'; ?>">
            ...
            <button class="h3-size naked-btn clickToReveal">
                <?php echo get_theme_mod('pt_skills_button_label', "Покажи мне остальные!"); ?>
            </button>
        </div>
    </section>
<?php endif; ?>