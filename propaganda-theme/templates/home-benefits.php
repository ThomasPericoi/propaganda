    ...
    <div class="container">
        ...
        <div class="card-grid benefits-grid">
            <div class="grid-item benefit">
                <div class="icon">
                    <img src="<?php echo get_template_directory_uri(); ?>/assets/icons/<?php echo get_theme_mod('pt_benefits_content_1_icon', 'hot-air-balloon') ?>.svg" class="undraggable" alt="">
                </div>
            ...
            <div class="grid-item benefit">
                <div class="icon">
                    <img src="<?php echo get_template_directory_uri(); ?>/assets/icons/<?php echo get_theme_mod('pt_benefits_content_2_icon', 'hot-air-balloon') ?>.svg" class="undraggable" alt="">
                </div>
            ...
            <div class="grid-item benefit">
                <div class="icon">
                    <img src="<?php echo get_template_directory_uri(); ?>/assets/icons/<?php echo get_theme_mod('pt_benefits_content_3_icon', 'hot-air-balloon') ?>.svg" class="undraggable" alt="">
                </div>
            ...
            <div class="grid-item benefit">
                <div class="icon">
                    <img src="<?php echo get_template_directory_uri(); ?>/assets/icons/<?php echo get_theme_mod('pt_benefits_content_4_icon', 'hot-air-balloon') ?>.svg" class="undraggable" alt="">
                </div>
