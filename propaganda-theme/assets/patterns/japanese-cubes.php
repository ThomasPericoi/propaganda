<svg xmlns='http://www.w3.org/2000/svg' width='100%' height='100%' class="svg-background" style="transform:scale(2);">
    <defs>
        <pattern id='japanese-cubes' patternUnits='userSpaceOnUse' width='40' height='69.282' transform-origin='<?php echo $args['transform-origin']; ?>'>
