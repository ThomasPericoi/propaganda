<svg xmlns='http://www.w3.org/2000/svg' width='100%' height='100%' class="svg-background" style="transform:scale(1.5);">
    <defs>
        <pattern id='ichimatu' patternUnits='userSpaceOnUse' width='80' height='80' transform-origin='<?php echo $args['transform-origin'] ?>'>
